...
{
    public partial class AddAttachmentIdToDataBase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChatMessageMessageId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Attachment", x => x.AttachmentId);
                    table.ForeignKey(
                        name: "FK_Attachment_Chats_ChatMessageMessageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attachment_ChatMessageMessageId",
                table: "Attachment",
